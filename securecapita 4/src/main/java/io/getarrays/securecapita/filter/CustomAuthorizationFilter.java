...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    private static final String[] PUBLIC_ROUTES = {"/user/login", "/user/verify/code", "/user/register", "/purchaseRequisition/create","  StockItemRequisition/create", "/user/refresh/token", "/user/image"};
