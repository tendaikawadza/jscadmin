...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_URLS = { "/user/verify/password/**",
            ...
            "/user/refresh/token/**", "/user/image/**","user/list/**", "/purchaseRequisition/**", "/ StockItemRequisition/**",  "users/{userId}/**" };
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().requestMatchers(DELETE, "/  StockItemRequisition/delete/**").hasAnyAuthority("DELETE:  StockItemRequisition");

        http.authorizeHttpRequests().requestMatchers(DELETE, "/  /delete/**").hasAnyAuthority("DELETE:  StockItemRequisition");
        http.authorizeHttpRequests().requestMatchers(DELETE, "/     /delete/**").hasAnyAuthority("DELETE:  StockItemRequisition");
